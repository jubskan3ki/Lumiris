        ...
        <div className="bg-background mx-auto flex h-dvh max-w-md flex-col items-center justify-center px-6 text-center">
            ...
            >
                ...
                <div className="space-y-1.5">
                    <h1 className="text-foreground text-xl font-semibold">Aucun passeport trouvé</h1>
                    <p className="text-muted-foreground text-sm">
                        L&apos;ID <span className="text-foreground font-mono">{passportId}</span> n&apos;est pas dans
                        notre registre.
                    </p>
                </div>
                <Link
