...
import { Filter, MapPin, Search, ShieldCheck, ShieldX, Star } from 'lucide-react';
...
type CandidatureStatus = 'pending' | 'verified' | 'rejected';
                                    ...
                                    >
                                        <div className="flex items-baseline justify-between">
                                            ...
                                            <span className="font-mono text-[10px]">
                                                <Star className="text-lumiris-amber inline h-3 w-3 fill-current" />{' '}
                                                {rev.rating}/5 · {rev.ts}
                                            </span>
                                        </div>
